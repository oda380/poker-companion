          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                home games. Track players, manage blinds, and keep a detailed
                history of every hand—all without requiring a centralized
                server.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                This app acts as your digital dealer for offline games, perfect
                for beginners:
              </p>
              <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside mt-2">
                ...
                <li>
                  <strong>Calculate:</strong> Let the app handle pot math, bets,
                  and side pots.
                </li>
                <li>
